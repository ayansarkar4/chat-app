...
const ChatContainer = () => {
  ...
  useEffect(() => {
    if (selectedUser) {
      ...
      // ✅ Reset unseen messages for this user immediately
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="absolute -bottom-1 left-0 right-0 flex items-center gap-3 p-4 ">
        <div className="flex-1 flex items-center bg-white/10 px-5 py-3 rounded-full ">
          <input
